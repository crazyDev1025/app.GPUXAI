(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [4874],
  {
    ...
    4874: (e, t, r) => {
          ...
          this.indexedDb = (function (e = {}) {
            let t = {
              ...
              n = async () => {
                if (!t.watching)
                  for (let e in ((t.watching = !0), t.mounts))
                    t.unwatch[e] = await x(t.mounts[e], s, e);
              },
              o = async () => {
                if (t.watching) {
              ...
              c = {
                ...
                async dispose() {
                  await Promise.all(Object.values(t.mounts).map((e) => D(e)));
                },
                watch: async (e) => (
                  await n(),
      ...
      var eD = Object.defineProperty,
        eS = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        eP = (e, t, r) => eS(e, "symbol" != typeof t ? t + "" : t, r);
      n();
      class eO {
        constructor(e) {
          (this.opts = e), eP(this, "protocol", "wc"), eP(this, "version", 2);
        }
      }
      s.EventEmitter;
      class eA {
        ...
        return {
          ...
          error:
            ...
            void 0 === i
              ? eU(eR)
              : ("string" == typeof i &&
                  (i = Object.assign(Object.assign({}, eU(ej)), {
                    message: i,
                  })),
                void 0 !== s && (i.data = s),
                (n = i.code),
      ...
      class e2 extends eG {
        ...
        async request(e, t) {
          return this.requestStrict(
            ez(e.method, e.params || [], e.id || eM().toString()),
            t
          );
        }
      ...
      class e6 {
        ...
        emitError(e) {
          let t = this.parseError(
            Error(
              e?.message ||
                `WebSocket connection failed for host: ${e3(this.url)}`
            )
          );
      ...
      let tU = ({ name: e, prefix: t, encode: r, decode: i }) =>
          new tk(e, t, r, i),
      ...
      function rt(e, t) {
        ...
        do {
          if (n >= o)
            throw ((rt.bytes = 0), RangeError("Could not decode varint"));
          (r = e[n++]),
          ...
          (this.core = e),
            ...
            rI(this, "getPayloadSenderPublicKey", (e, t = eT.EWt) => {
              ...
              return r.senderPublicKey
                ? (0, eN.dI)(r.senderPublicKey, eT.bEt)
                : void 0;
            }),
            (this.core = e),
            (this.logger = eo(t, this.name)),
        ...
        constructor(e, t) {
          super(e, t),
            ...
            rj(
              ...
              "has",
              (e, t) => (
                this.isInitialized(), "u" > typeof this.get(e)[(0, eT.ALl)(t)]
              )
            ),
      ...
      class r4 extends ev {
        ...
        async rpcSubscribe(e, t, r) {
          ...
          let s = {
            method: (0, eT.aa1)(t.protocol).subscribe,
            params: { topic: e },
          };
          this.logger.debug("Outgoing Relay Payload"),
            this.logger.trace({
          ...
          try {
            ...
            let i = new Promise(async (t) => {
                let r = (i) => {
                  i.topic === e &&
                    (this.events.removeListener(tf.created, r), t(i.id));
                };
        ...
        rpcUnsubscribe(e, t, r) {
          let i = {
            method: (0, eT.aa1)(r.protocol).unsubscribe,
            params: { topic: e, id: t },
          };
          return (
            this.logger.debug("Outgoing Relay Payload"),
        ...
        onSubscribe(e, t) {
          this.setSubscription(e, r5(r3({}, t), { id: e })),
            this.pending.delete(t.topic);
        }
        onBatchSubscribe(e) {
          e.length &&
            e.forEach((e) => {
              this.setSubscription(e.id, r3({}, e)),
        ...
        async batchSubscribe(e) {
          e.length &&
            ...
            this.onBatchSubscribe(
              await Promise.all(
                e.map(async (e) =>
                  r5(r3({}, e), { id: await this.getSubscriptionId(e.topic) })
                )
              )
            ));
        }
      ...
      class io extends em {
              ...
              new Promise(async (r, i) => {
                (o =
                  (await this.subscriber
                    .subscribe(
                      e,
                      ii({ internal: { throwOnFailedPublish: n } }, t)
                    )
                    .catch((e) => {
                      n && i(e);
                    })) || o),
        ...
        async onLinkMessageEvent(e, t) {
          ...
          this.events.emit(tc.message, e),
            await this.recordMessageEvent(e, td.inbound);
        }
        async connect(e) {
          await this.confirmOnlineStateOrThrow(),
            e &&
        ...
        async onProviderPayload(e) {
          ...
          } else eQ(e) && this.events.emit(tc.message_ack, e);
        }
      ...
      class iD {
        constructor(e, t) {
          (this.core = e),
            (this.logger = t),
            ix(this, "name", "pairing"),
            ix(this, "version", "0.3"),
            ix(this, "events", new (n())()),
            ix(this, "pairings"),
            ix(this, "initialized", !1),
            ix(this, "storagePrefix", tt),
            ix(this, "ignoredPayloadTypes", [eT.Lp_]),
            ix(this, "registeredMethods", []),
            ix(this, "init", async () => {
              this.initialized ||
            ...
            ix(this, "register", ({ methods: e }) => {
              this.isInitialized(),
                (this.registeredMethods = [
                  ...new Set([...this.registeredMethods, ...e]),
                ]);
            }),
            ix(this, "create", async (e) => {
              this.isInitialized();
              let t = (0, eT.two)(),
            ...
            ix(this, "pair", async (e) => {
              ...
              if (
                ...
                if (
                  ...
                  r.addTrace(t_.existing_pairing),
                  t.active)
                )
                  throw (
            ...
            ix(this, "updateExpiry", async ({ topic: e, expiry: t }) => {
              this.isInitialized(),
                await this.pairings.update(e, { expiry: t });
            }),
            ix(this, "updateMetadata", async ({ topic: e, metadata: t }) => {
              this.isInitialized(),
            ...
            ix(this, "disconnect", async (e) => {
              ...
              this.pairings.keys.includes(t) &&
                (await this.sendRequest(
                  t,
                  "wc_pairingDelete",
                  (0, eT.Hjj)("USER_DISCONNECTED")
                ),
                await this.deletePairing(t));
            }),
            ix(this, "formatUriFromPairing", (e) => {
              this.isInitialized();
            ...
            ix(this, "sendRequest", async (e, t, r) => {
              let i = ez(t, r),
            ...
            ix(this, "sendResult", async (e, t, r) => {
              let i = eF(e, r),
            ...
            ix(this, "deletePairing", async (e, t) => {
            ...
            ix(this, "cleanup", async () => {
              let e = this.pairings
                .getAll()
                .filter((e) => (0, eT._dF)(e.expiry));
              await Promise.all(e.map((e) => this.deletePairing(e.topic)));
            }),
            ix(this, "onRelayEventRequest", async (e) => {
            ...
            ix(this, "onRelayEventResponse", async (e) => {
              let { topic: t, payload: r } = e,
            ...
            ix(this, "onPairingPingRequest", async (e, t) => {
              let { id: r } = t;
              try {
            ...
            ix(this, "onPairingPingResponse", (e, t) => {
              let { id: r } = t;
              setTimeout(() => {
                e0(t)
            ...
            ix(this, "onPairingDeleteRequest", async (e, t) => {
              let { id: r } = t;
              try {
            ...
            ix(this, "onUnknownRpcMethodRequest", async (e, t) => {
              let { id: r, method: i } = t;
              try {
            ...
            ix(this, "isValidDisconnect", async (e) => {
              if (!(0, eT.TeY)(e)) {
                let { message: t } = (0, eT.GuA)(
                  "MISSING_OR_INVALID",
                  `disconnect() params: ${e}`
            ...
            ix(this, "isValidPairingTopic", async (e) => {
              if (!(0, eT.Qhg)(e, !1)) {
                let { message: t } = (0, eT.GuA)(
                  "MISSING_OR_INVALID",
      ...
      class iR extends eE {
        ...
        expire(e, t) {
          this.expirations.delete(e),
            this.events.emit(tb.expired, { target: e, expiration: t });
        }
        checkExpirations() {
                      ...
                      if (s.data && "string" == typeof s.data)
                        try {
                          ...
                          if ("verify_attestation" === n.type) {
                            if ((0, eC.Cq)(n.attestation).payload.id !== r)
                              return;
                            clearInterval(t),
                              e.body.removeChild(a),
            ...
            iW(this, "restore", async () => {
              try {
                ...
                e.forEach((e) => {
                  this.events.set(
                    e.eventId,
                    iG(iG({}, e), this.setMethods(e.eventId))
                  );
                });
              } catch (e) {
                this.logger.warn(e);
      ...
      var iZ = Object.defineProperty,
        ...
        i0 = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        i1 = (e, t) => {
          for (var r in t || (t = {})) iX.call(t, r) && i0(e, r, t[r]);
          if (iJ) for (var r of iJ(t)) iQ.call(t, r) && i0(e, r, t[r]);
          return e;
        },
      ...
      class i8 extends eh {
        constructor(e) {
          ...
          let { logger: i, chunkLoggerController: n } = (function (e) {
            ...
            opts: es({
              level:
                "string" == typeof e?.logger && e.logger ? e.logger : tr.logger,
              name: te,
            }),
          ...
          (this.logChunkController = n),
            ...
            (this.crypto = new rx(this, this.logger, e?.keychain)),
            (this.history = new iA(this, this.logger)),
            (this.expirer = new iR(this, this.logger)),
            (this.storage =
              null != e && e.storage
                ? e.storage
                : new q(i1(i1({}, ti), e?.storageOptions))),
            (this.relayer = new io({
              core: this,
              logger: this.logger,
              relayUrl: this.relayUrl,
            ...
            (this.pairing = new iD(this, this.logger)),
        ...
        constructor(e) {
          super(e),
            ...
            sy(this, "approve", async (e) => {
              ...
              let s = this.client.core.eventClient.createEvent({
                properties: {
                  ...
                  trace: [tx.session_approve_started],
                },
              });
              try {
                this.isInitialized(), await this.confirmOnlineStateOrThrow();
              ...
              y ||
                (y =
                  null == (i = this.client.core.eventClient)
                    ? void 0
                    : i.createEvent({
                        type: tx.session_approve_started,
                        properties: {
                          topic: d,
                          trace: [
                            tx.session_approve_started,
                            tx.session_namespaces_validation_success,
                          ],
                        },
                      }));
              let m = await this.client.core.crypto.generateKeyPair(),
                ...
                E = tu.relay;
              y.addTrace(tx.subscribing_session_topic);
              try {
              ...
              y.addTrace(tx.subscribe_session_topic_success);
              let _ = sg(sf({}, v), {
                topic: w,
                requiredNamespaces: f,
                optionalNamespaces: g,
              ...
              await this.client.session.set(w, _), y.addTrace(tx.store_session);
              try {
                y.addTrace(tx.publishing_session_settle),
                  await this.sendRequest({
                    topic: w,
                  ...
                  y.addTrace(tx.session_settle_publish_success),
                  y.addTrace(tx.publishing_session_approve),
                  ...
                  y.addTrace(tx.session_approve_publish_success);
              } catch (e) {
                throw (
            ...
            sy(
              ...
              (e) => (
                this.isInitialized(),
                this.client.session.getAll().filter((t) => (0, eT.HNf)(t, e))
              )
            ),
            sy(this, "getPendingSessionRequests", () =>
            ...
            sy(this, "authenticate", async (e, t) => {
              ...
              if (
                (await Promise.all([
                  this.client.auth.authKeys.set(so, {
                    responseTopic: v,
                    publicKey: w,
                  }),
              ...
              let E =
                ...
                },
                {
                  ...
                  resolve: D,
                  reject: S,
                } = (0, eT.Wx8)(E, "Request expired"),
                P = e$(),
                O = (0, eT.hEn)("session_connect", I.id),
                A = (0, eT.hEn)("session_request", P),
                C = async ({ error: e, session: t }) => {
                  this.events.off(A, T), e ? S(e) : t && D({ session: t });
                },
                T = async (e) => {
                  var r, i, s;
                  let o;
              ...
              try {
                if (s) {
                  let e = ez("wc_sessionAuthenticate", _, P);
            ...
            sy(this, "approveSessionAuthenticate", async (e) => {
              ...
              let { id: r, auths: i } = e,
                s = this.client.core.eventClient.createEvent({
                  properties: {
                    topic: r.toString(),
                    trace: [tS.authenticated_session_approve_started],
                  },
                });
              try {
                this.isInitialized();
              } catch (e) {
                throw (s.setError(tP.no_internet_connection), e);
              }
              let n = this.getPendingAuthRequest(r);
              if (!n)
                throw (
                  (s.setError(
                    tP.authenticated_session_pending_request_not_found
                  ),
              ...
              if (
                (s.addTrace(tS.create_authenticated_session_topic),
                u?.length > 0)
              ) {
                (t = {
                  topic: p,
                ...
                try {
                  ...
                  throw (
                    (s.setError(
                      tP.subscribe_authenticated_session_topic_failure
                    ),
                    e)
                  );
                }
                s.addTrace(tS.subscribe_authenticated_session_topic_success),
                  await this.client.session.set(p, t),
                  s.addTrace(tS.store_authenticated_session),
                  await this.client.core.pairing.updateMetadata({
                    topic: n.pairingTopic,
                    metadata: n.requester.metadata,
                  });
              }
              s.addTrace(tS.publishing_authenticated_session_approve);
              try {
                await this.sendResult({
                  topic: l,
                  id: r,
                ...
                throw (
                  (s.setError(tP.authenticated_session_approve_publish_failure),
                  e)
                );
              }
              return (
              ...
              await this.client.core.relayer.unsubscribe(r),
                ...
                r ===
                  (null == (t = this.sessionRequestQueue.queue[0])
                    ? void 0
                    : t.topic) && (this.sessionRequestQueue.state = sr.idle),
                s &&
            ...
            sy(this, "setProposal", async (e, t) => {
              this.client.core.expirer.set(
                e,
                (0, eT.Xw0)(se.wc_sessionPropose.req.ttl)
              ),
            ...
            sy(this, "setPendingSessionRequest", async (e) => {
              let { id: t, topic: r, params: i, verifyContext: s } = e,
                n =
                  ...
                  (0, eT.Xw0)(se.wc_sessionRequest.req.ttl);
            ...
            sy(this, "onSessionSettleRequest", async (e, t) => {
              ...
              try {
                ...
                await this.client.session.set(d.topic, d),
                  ...
                  this.events.emit(
                    (0, eT.hEn)("session_connect", h.proposalId),
                    { session: d }
                  ),
              ...
              try {
                ...
                let e = this.client.session.get(s),
                  n = await this.getVerifyContext({
                    attestationId: o,
                    hash: (0, eT.ALl)(
                      JSON.stringify(ez("wc_sessionRequest", h, l))
                    ),
                    encryptedId: a,
            ...
            sy(this, "onSessionRequestResponse", (e, t) => {
              ...
              if (0 === this.events.listenerCount(i))
                throw Error(`emitting ${i} without any listeners`);
              e0(t)
                ? this.events.emit((0, eT.hEn)("session_request", r), {
                    result: t.result,
                  })
                : e1(t) &&
                  this.events.emit((0, eT.hEn)("session_request", r), {
                  ...
                  r
                    ...
                    .forEach((e) => {
                      ...
                      if (0 === this.events.listenerCount(i))
                        throw Error(`emitting ${i} without any listeners`);
                      this.events.emit(
                        (0, eT.hEn)("session_request", e.request.id),
                        { error: t }
                      );
                    });
              }
            ...
            sy(this, "processSessionRequestQueue", () => {
              ...
              try {
                (this.sessionRequestQueue.state = sr.active),
            ...
            sy(this, "isValidConnect", async (e) => {
              ...
              if (
                ((0, eT.b07)(t) || (await this.isValidPairingTopic(t)),
                !(0, eT.V9G)(o, !0))
              ) {
                let { message: e } = (0, eT.GuA)(
                  "MISSING_OR_INVALID",
            ...
            sy(this, "isValidApprove", async (e) => {
              if (!(0, eT.TeY)(e))
                throw Error(
                  (0, eT.GuA)("MISSING_OR_INVALID", `approve() params: ${e}`)
                    .message
                );
              let {
                id: t,
            ...
            sy(this, "isValidAuthenticate", (e) => {
              ...
              if (
                [...new Set(t.map((e) => (0, eT._Yb)(e).namespace))].length > 1
              )
                throw Error(
      ...
      var sx = Object.defineProperty,
        sD = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        sS = (e, t, r) => sD(e, "symbol" != typeof t ? t + "" : t, r);
      class sP {
        constructor(e, t) {
          (this.core = e),
            (this.logger = t),
            sS(this, "authKeys"),
            sS(this, "pairingTopics"),
            sS(this, "requests"),
      ...
      class sT extends eO {
        constructor(e) {
          super(e),
            ...
            sC(this, "removeListener", (e, t) =>
              this.events.removeListener(e, t)
            ),
            sC(this, "removeAllListeners", (e) =>
          ...
          (this.core = e?.core || new i8(e)),
            ...
            (this.auth = new sP(this.core, this.logger));
        }
        static async init(e) {
          let t = new sT(e);
      ...
      class sH {
        ...
        async send(e) {
          ...
          try {
            let t = (0, C.h)(e),
              r = await (
                await sR()(this.url, sz(sM({}, sF), { body: t }))
              ).json();
      ...
      function nt(e) {
        return (
          null !== e && "object" == typeof e && "[object Arguments]" === s8(e)
        );
      }
          ...
          return (function (e, ...t) {
            ...
            for (let e = 0; e < r.length; e++)
              s = (function e(t, r, i, s) {
                if (
                  (sQ(t) && (t = Object(t)), null == r || "object" != typeof r)
                )
                  return t;
                if (s.has(r))
                  return (function (e) {
      ...
      var n_ = Object.defineProperty,
        nI = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        nx = (e, t, r) => nI(e, "symbol" != typeof t ? t + "" : t, r);
      class nD {
        constructor(e) {
          nx(this, "name", "polkadot"),
            nx(this, "client"),
            nx(this, "httpProviders"),
            nx(this, "events"),
            nx(this, "namespace"),
            nx(this, "chainId"),
      ...
      class nk {
        ...
        createHttpProvider(e, t) {
          let r =
            t ||
            nu(`${this.name}:${e}`, this.namespace, this.client.core.projectId);
          if (!r) throw Error(`No RPC url provided for chainId: ${e}`);
          return new e2(new sH(r, nv("disableProviderPing")));
        }
        setHttpProvider(e, t) {
        ...
        async getUserOperationReceipt(e, t) {
          ...
          let i = new URL(e),
            s = await fetch(i, {
              ...
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify(
                ez("eth_getUserOperationReceipt", [
      ...
      class nW {
        ...
        createHttpProvider(e, t) {
          ...
          return typeof r > "u"
            ? void 0
            : new e2(new sH(r, nv("disableProviderPing")));
        }
      }
      ...
      class ow {
        ...
        createProviders() {
          ...
          let e = [
            ...new Set(
              Object.keys(this.session.namespaces).map((e) => (0, eT.kob)(e))
            ),
          ];
          nE("client", this.client),
            ...
            e.forEach((e) => {
              ...
              let t = (function (e, t) {
                ...
                r = np(t),
                i = om(
                  oy({}, nf(this.namespaces, this.optionalNamespaces)[e]),
                  { accounts: t, chains: r }
                );
              switch (e) {
                case "eip155":
                ...
                case "cosmos":
                  ...
                  break;
                case "polkadot":
                  this.rpcProviders[e] = new nD({ namespace: i });
                  break;
                case "cip34":
          ...
          this.client.on("session_ping", (e) => {
            ...
            this.client.on("session_event", (e) => {
              ...
              if ("accountsChanged" === s.name) {
                ...
                e &&
                  (0, eT.OP1)(e) &&
                  this.events.emit("accountsChanged", e.map(ny));
            ...
            this.client.on("session_delete", async (e) => {
              ...
              e.topic === (null == (t = this.session) ? void 0 : t.topic) &&
                ...
                this.events.emit(
                  "disconnect",
                  om(oy({}, (0, eT.Hjj)("USER_DISCONNECTED")), {
                    data: e.topic,
                  })
                ));
            }),
    ...
    6185: (e, t, r) => {
      ...
      function D(e, { size: t }) {
        if (x(e) > t) throw new I({ givenSize: x(e), maxSize: t });
      }
      function S(e, t = {}) {
        let { signed: r } = t;
        ...
        return "number" == typeof e || "bigint" == typeof e
          ...
          ? (function (e, t = {}) {
              ...
              return "number" == typeof t.size
                ? (D(r, { size: t.size }), E(r, { size: t.size }))
                : r;
            })(e, t)
          : A(e, t);
      }
      function A(e, t = {}) {
        ...
        let i = `0x${r}`;
        return "number" == typeof t.size
          ? (D(i, { size: t.size }), E(i, { dir: "right", size: t.size }))
          : i;
      }
      function C(e, t = {}) {
        let r;
      ...
      function L(e, t = {}) {
        let r = e;
        t.size &&
          (D(r, { size: t.size }), (r = E(r, { dir: "right", size: t.size })));
        let i = r.slice(2);
        i.length % 2 && (i = `0${i}`);
        let s = i.length / 2,
          n = new Uint8Array(s);
      ...
      function k(e, t = {}) {
        let r = N.encode(e);
        return "number" == typeof t.size
          ? (D(r, { size: t.size }), E(r, { dir: "right", size: t.size }))
          : r;
      }
      var U = r(61947);
      ...
      async function eu({ hash: e, signature: t }) {
        return (function (e) {
          ...
          return (function (e, t) {
            if (ec.has(`${e}.${void 0}`)) return ec.get(`${e}.${t}`);
      ...
      var ex = Object.defineProperty,
        ...
        eT = (e, t) => {
          ...
          if (eP) for (var r of eP(t)) eA.call(t, r) && eC(e, r, t[r]);
          return e;
        },
        eN = (e, t) => eD(e, eS(t));
      let eR = {
      ...
      function ej() {
        return (
          "u" > typeof eb &&
          "u" > typeof eb.versions &&
          "u" > typeof eb.versions.node
        );
      }
      function eL() {
        return (
      ...
      function eB() {
        return !ej() && !!(0, f.getNavigator)() && !!(0, f.getDocument)();
      }
      function eq() {
        return eL()
          ? eR.reactNative
            ...
            let e =
              ...
              "ReactNative" === navigator.product
                ...
                ? (function (e) {
                    ...
                    var l =
                      o[1] && o[1].split(".").join("_").split("_").slice(0, 3);
                    l
                      ? l.length < 3 &&
                        (l = s(
                          s([], l, !0),
      ...
      function eW(e = p.FIVE_MINUTES, t) {
        let r, i, s, n;
      ...
      async function e3({ id: e, topic: t, wcDeepLink: i }) {
        var s, n;
        try {
          if (!i) return;
          ...
          let c = (function (e, t, r) {
              ...
              if (e.startsWith("https://t.me")) {
                ...
                s = `${s}${t}${(function (e, t = !1) {
                  let r = ew.from(e).toString("base64");
      ...
      async function e5(e, t) {
        let r = "";
        try {
          if (eB() && (r = localStorage.getItem(t))) return r;
          r = await e.getItem(t);
        } catch (e) {
          console.error(e);
        }
      ...
      function e9() {
        return "u" > typeof eb && "true" === eb.env.IS_VITEST;
      }
      function e7(e) {
        return ew.from(e, "base64").toString("utf-8");
      }
      function te(e) {
      ...
      let to = BigInt(0x100000000 - 1),
        ta = BigInt(32),
        tc = (e, t, r) => (e << r) | (t >>> (32 - r)),
        tl = (e, t, r) => (t << r) | (e >>> (32 - r)),
        th = (e, t, r) => (t << (r - 32)) | (e >>> (64 - r)),
      ...
      let tg = 68 === new Uint8Array(new Uint32Array([0x11223344]).buffer)[0];
      function ty(e) {
        for (let r = 0; r < e.length; r++) {
          var t;
          e[r] =
      ...
      let tE = [],
        ...
        tO = BigInt(256),
        tA = BigInt(113);
      for (let e = 0, t = tD, r = 1, i = 0; e < 24; e++) {
        ([r, i] = [i, (2 * r + 3 * i) % 5]),
          tE.push(2 * (5 * i + r)),
          t_.push((((e + 1) * (e + 2)) / 2) % 64);
        let s = tx;
        for (let e = 0; e < 7; e++)
          (t = ((t << tD) ^ ((t >> tP) * tA)) % tO) & tS &&
            (s ^= tD << ((tD << BigInt(e)) - tD));
        tI.push(s);
      }
      let [tC, tT] = (function (e, t = !1) {
          let r = new Uint32Array(e.length),
            i = new Uint32Array(e.length);
          for (let s = 0; s < e.length; s++) {
            let { h: n, l: o } = (function (e, t = !1) {
              return t
                ? { h: Number(e & to), l: Number((e >> ta) & to) }
                : { h: 0 | Number((e >> ta) & to), l: 0 | Number(e & to) };
            })(e[s], t);
            [r[s], i[s]] = [n, o];
          }
          return [r, i];
        })(tI, !0),
        tN = (e, t, r) => (r > 32 ? th(e, t, r) : tc(e, t, r)),
        tR = (e, t, r) => (r > 32 ? tu(e, t, r) : tl(e, t, r));
      class tj extends tb {
        constructor(e, t, r, i = !1, s = 24) {
          if (
            (super(),
      ...
      let tL = tw(() => new tj(136, 1, 32));
      function tk(e) {
        let t = `Ethereum Signed Message:
${e.length}`,
          r = new TextEncoder().encode(t + e);
        return "0x" + ew.from(tL(r)).toString("hex");
      }
      async function tU(e, t, r, i, s, n) {
        switch (r.t) {
          case "eip191":
            return await tB(e, t, r.s);
          case "eip1271":
            return await tq(e, t, r.s, i, s, n);
          default:
            throw Error(
      ...
      async function tB(e, t, r) {
        return (
          (await eu({ hash: tk(t), signature: r })).toLowerCase() ===
          e.toLowerCase()
        );
      }
      async function tq(e, t, r, i, s, n) {
        let o = ev(i);
      ...
      function t$(e) {
        ...
        let s = ew.from(e, "base64").slice(1, 65);
        return ed.encode(s);
      }
      var tM = Object.defineProperty,
        ...
        tW = (e, t) => {
          ...
          if (tH) for (var r of tH(t)) tK.call(t, r) && tG(e, r, t[r]);
          return e;
        },
        tY = (e, t) => tz(e, tF(t));
      let tZ = (e) => e?.split(":"),
      ...
      async function t0(e) {
        let { cacao: t, projectId: r } = e,
          ...
          n = t1(s, s.iss),
          o = tQ(s.iss);
        return await tU(o, n, i, tX(s.iss), r);
      }
      let t1 = (e, t) => {
...
`)
      ...
      function t3(e) {
        ...
        let r =
          ...
          JSON.parse(ew.from(t, "base64").toString("utf-8")));
        return t2(r), r;
      }
      function t5(e, t, r) {
        return t8(
      ...
      function rr(e, ...t) {
        if (!rt(e)) throw Error("Uint8Array expected");
        if (t.length > 0 && !t.includes(e.length))
          throw Error(
            "Uint8Array expected of length " + t + ", got length=" + e.length
          );
      ...
      let rn = (e) =>
        ...
        ro = (e) => new DataView(e.buffer, e.byteOffset, e.byteLength);
      ...
      let rd = (e) => Uint8Array.from(e.split("").map((e) => e.charCodeAt(0))),
        rp = rd("expand 16-byte k"),
        rf = rd("expand 32-byte k"),
        rg = rn(rp),
        ry = rn(rf);
      function rm(e, t) {
        return (e << t) | (e >>> (32 - t));
      ...
      let rw = 0x100000000 - 1,
        rv = new Uint32Array(),
        rE = (e, t) => (255 & e[t++]) | ((255 & e[t++]) << 8);
      class r_ {
        constructor(e) {
          (this.blockLen = 16),
            (this.outputLen = 16),
          ...
          (this.r[0] = 8191 & t),
            ...
            (this.r[9] = (c >>> 5) & 127);
          for (let t = 0; t < 8; t++) this.pad[t] = rE(e, 16 + 2 * t);
        }
        process(e, t, r = !1) {
          let { h: i, r: s } = this,
            n = s[0],
            ...
            N = i[9] + ((_ >>> 5) | (2048 * !r)),
            R = 0,
            j = 0 + I * n + 5 * f * x + 5 * p * D + 5 * d * S + 5 * u * P;
          (R = j >>> 13),
            (j &= 8191),
            (j += 5 * h * O + 5 * l * A + 5 * c * C + 5 * a * T + 5 * o * N),
            (R += j >>> 13),
            (j &= 8191);
          let L = R + I * o + x * n + 5 * f * D + 5 * p * S + 5 * d * P;
          (R = L >>> 13),
            (L &= 8191),
            (L += 5 * u * O + 5 * h * A + 5 * l * C + 5 * c * T + 5 * a * N),
            (R += L >>> 13),
            (L &= 8191);
          let k = R + I * a + x * o + D * n + 5 * f * S + 5 * p * P;
          (R = k >>> 13),
            (k &= 8191),
            (k += 5 * d * O + 5 * u * A + 5 * h * C + 5 * l * T + 5 * c * N),
            (R += k >>> 13),
            (k &= 8191);
          let U = R + I * c + x * a + D * o + S * n + 5 * f * P;
          (R = U >>> 13),
            (U &= 8191),
            (U += 5 * p * O + 5 * d * A + 5 * u * C + 5 * h * T + 5 * l * N),
            (R += U >>> 13),
            (U &= 8191);
          let B = R + I * l + x * c + D * a + S * o + P * n;
          (R = B >>> 13),
            (B &= 8191),
            (B += 5 * f * O + 5 * p * A + 5 * d * C + 5 * u * T + 5 * h * N),
            (R += B >>> 13),
            (B &= 8191);
          let q = R + I * h + x * l + D * c + S * a + P * o;
          (R = q >>> 13),
            (q &= 8191),
            (q += O * n + 5 * f * A + 5 * p * C + 5 * d * T + 5 * u * N),
            (R += q >>> 13),
            (q &= 8191);
          let $ = R + I * u + x * h + D * l + S * c + P * a;
          (R = $ >>> 13),
            ($ &= 8191),
            ($ += O * o + A * n + 5 * f * C + 5 * p * T + 5 * d * N),
            (R += $ >>> 13),
            ($ &= 8191);
          let M = R + I * d + x * u + D * h + S * l + P * c;
          (R = M >>> 13),
            (M &= 8191),
            (M += O * a + A * o + C * n + 5 * f * T + 5 * p * N),
            (R += M >>> 13),
            (M &= 8191);
          let z = R + I * p + x * d + D * u + S * h + P * l;
          (R = z >>> 13),
            (z &= 8191),
            (z += O * c + A * a + C * o + T * n + 5 * f * N),
            (R += z >>> 13),
            (z &= 8191);
          let F = R + I * f + x * p + D * d + S * u + P * h;
          (R = F >>> 13),
            (F &= 8191),
        ...
        destroy() {
          ru(this.h, this.r, this.buffer, this.pad);
        }
        digestInto(e) {
          ri(this),
            (function (e, t) {
      ...
      let rI = (function (e) {
          let t = (t, r) => e(r).update(ra(t)).digest(),
        ...
        rx = (function (e, t) {
          ...
          return (
            ...
            (t, a, c, l, h = 0) => {
              ...
              if (i) {
                ...
                i(g, y, rn(a.subarray(0, 16)), y), (a = a.subarray(16));
              }
              let m = 16 - s;
              if (m !== a.length)
          ...
          function (e, t, r, i, s, n = 20) {
            let o = e[0],
              ...
              k = v;
            for (let e = 0; e < n; e += 2)
              (A = (A + (R = rm(R ^ (E = (E + D) | 0), 16))) | 0),
                (E = (E + (D = rm(D ^ A, 12))) | 0),
                (A = (A + (R = rm(R ^ E, 8))) | 0),
                (D = rm(D ^ A, 7)),
                (C = (C + (j = rm(j ^ (_ = (_ + S) | 0), 16))) | 0),
                (_ = (_ + (S = rm(S ^ C, 12))) | 0),
                (C = (C + (j = rm(j ^ _, 8))) | 0),
                (S = rm(S ^ C, 7)),
                (T = (T + (L = rm(L ^ (I = (I + P) | 0), 16))) | 0),
                (I = (I + (P = rm(P ^ T, 12))) | 0),
                (T = (T + (L = rm(L ^ I, 8))) | 0),
                (P = rm(P ^ T, 7)),
                (N = (N + (k = rm(k ^ (x = (x + O) | 0), 16))) | 0),
                (x = (x + (O = rm(O ^ N, 12))) | 0),
                (N = (N + (k = rm(k ^ x, 8))) | 0),
                (O = rm(O ^ N, 7)),
                (T = (T + (k = rm(k ^ (E = (E + S) | 0), 16))) | 0),
                (E = (E + (S = rm(S ^ T, 12))) | 0),
                (T = (T + (k = rm(k ^ E, 8))) | 0),
                (S = rm(S ^ T, 7)),
                (N = (N + (R = rm(R ^ (_ = (_ + P) | 0), 16))) | 0),
                (_ = (_ + (P = rm(P ^ N, 12))) | 0),
                (N = (N + (R = rm(R ^ _, 8))) | 0),
                (P = rm(P ^ N, 7)),
                (A = (A + (j = rm(j ^ (I = (I + O) | 0), 16))) | 0),
                (I = (I + (O = rm(O ^ A, 12))) | 0),
                (A = (A + (j = rm(j ^ I, 8))) | 0),
                (O = rm(O ^ A, 7)),
                (C = (C + (L = rm(L ^ (x = (x + D) | 0), 16))) | 0),
                (x = (x + (D = rm(D ^ C, 12))) | 0),
                (C = (C + (L = rm(L ^ x, 8))) | 0),
                (D = rm(D ^ C, 7));
            let U = 0;
        ...
        rS = (e, t) => {
          e.update(t);
          let r = t.length % 16;
          r && e.update(rD.subarray(r));
        },
        rP = new Uint8Array(32);
      function rO(e, t, r, i, s) {
        ...
        let a = new Uint8Array(16),
          c = ro(a);
        rl(c, 0, BigInt(s ? s.length : 0), !0),
          rl(c, 8, BigInt(i.length), !0),
          o.update(a);
        let l = o.digest();
        return ru(n, a), l;
      }
      let rA = ((e, t) => {
        function r(i, ...s) {
          if ((rr(i), void 0 !== e.nonceLength)) {
            let t = s[0];
            if (!t) throw Error("nonce / iv required");
            e.varSizeNonce ? rr(t) : rr(t, e.nonceLength);
          }
          let n = e.tagLength;
          n && void 0 !== s[1] && rr(s[1]);
          let o = t(i, ...s),
          ...
          return {
            encrypt(e, t) {
              ...
              return (c = !0), rr(e), a(o.encrypt.length, t), o.encrypt(e, t);
            },
            decrypt(e, t) {
              if ((rr(e), n && e.length < n))
                throw Error(
        ...
        ((e) => (t, r, i) => ({
          encrypt(s, n) {
            ...
            e(t, r, a, a, 1);
            let c = rO(e, t, r, a, i);
            return n.set(c, o), ru(c), n;
          },
          decrypt(s, n) {
            n = rc(s.length - 16, n, !1);
            ...
            return n.set(s.subarray(0, -16)), e(t, r, n, n, 1), ru(c), n;
          },
        }))(rx)
      );
      class rC extends tb {
        constructor(e, t) {
          super(), (this.finished = !1), (this.destroyed = !1), ti(e);
          let r = tm(t);
          if (
      ...
      let rT = (e, t, r) => new rC(e, t).update(r).digest();
      rT.create = (e, t) => new rC(e, t);
      let rN = new Uint8Array([0]),
        rR = new Uint8Array(),
        rj = (e, t, r, i, s) =>
          (function (e, t, r, i = 32) {
            if ((ti(e), tt(i), i > 255 * e.outputLen))
            ...
            for (let t = 0; t < s; t++)
              (rN[0] = t + 1),
                ...
                o._cloneInto(a);
            return (
              o.destroy(), a.destroy(), c.fill(0), rN.fill(0), n.slice(0, i)
            );
          })(
            e,
            (function (e, t, r) {
      ...
      class rL extends tb {
        ...
        digestInto(e) {
          ts(this), tn(e, this), (this.finished = !0);
      ...
      class rq extends rL {
        ...
        process(e, t) {
          for (let r = 0; r < 16; r++, t += 4) rB[r] = e.getUint32(t, !1);
          for (let e = 16; e < 64; e++) {
            let t = rB[e - 15],
              r = rB[e - 2],
              i = tf(t, 7) ^ tf(t, 18) ^ (t >>> 3),
              s = tf(r, 17) ^ tf(r, 19) ^ (r >>> 10);
            rB[e] = (s + rB[e - 7] + i + rB[e - 16]) | 0;
          }
          ...
          for (let e = 0; e < 64; e++) {
            ...
            let t =
                (l +
                  (tf(o, 6) ^ tf(o, 11) ^ tf(o, 25)) +
                  (((h = o) & a) ^ (~h & c)) +
                  rk[e] +
                  rB[e]) |
                0,
              f =
                ((tf(r, 2) ^ tf(r, 13) ^ tf(r, 22)) +
                  (((u = r) & (d = i)) ^ (u & (p = s)) ^ (d & p))) |
                0;
            (l = c),
              (c = a),
      ...
      let rG = Array.from({ length: 256 }, (e, t) =>
        t.toString(16).padStart(2, "0")
      );
      function rW(e) {
        rV(e);
        let t = "";
        for (let r = 0; r < e.length; r++) t += rG[e[r]];
        return t;
      }
      function rY(e) {
        let t = e.toString(16);
      ...
      function rZ(e) {
        ...
        return "" === e ? rM : BigInt("0x" + e);
      }
      let rJ = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 };
      function rX(e) {
        return e >= rJ._0 && e <= rJ._9
          ? e - rJ._0
          : e >= rJ.A && e <= rJ.F
          ? e - (rJ.A - 10)
          : e >= rJ.a && e <= rJ.f
      ...
      function rQ(e) {
        ...
        for (let t = 0, s = 0; t < r; t++, s += 2) {
          let r = rX(e.charCodeAt(s)),
            n = rX(e.charCodeAt(s + 1));
      ...
      function r1(e) {
        return rV(e), rZ(rW(Uint8Array.from(e).reverse()));
      }
      function r2(e, t) {
        return rQ(e.toString(16).padStart(2 * t, "0"));
      }
      function r8(e, t) {
        return r2(e, t).reverse();
      }
      function r3(e, t, r) {
        let i;
        if ("string" == typeof t)
      ...
      let r6 = (e) => "bigint" == typeof e && rM <= e;
      function r4(e, t, r) {
        return r6(e) && r6(t) && r6(r) && t <= e && e < r;
      }
      function r9(e, t, r, i) {
        if (!r4(t, r, i))
          throw Error(
      ...
      function r7(e) {
        let t;
        for (t = 0; e > rM; e >>= rz, t += 1);
        return t;
      }
      let ie = (e) => (rF << BigInt(e - 1)) - rz,
        it = (e) => new Uint8Array(e),
        ir = (e) => Uint8Array.from(e);
      function ii(e, t, r) {
      ...
      var ic = Object.freeze({
        ...
        bitLen: r7,
        bitGet: function (e, t) {
          return (e >> BigInt(t)) & rz;
        },
        bitSet: function (e, t, r) {
          return e | ((r ? rz : rM) << BigInt(t));
        },
        bitMask: ie,
        createHmacDrbg: ii,
        validateObject: io,
      ...
      function iv(e, t) {
        if (e === il) throw Error("invert: expected non-zero number");
        if (t <= il) throw Error("invert: expected positive modulus, got " + t);
        let r = im(e, t),
          i = t,
          s = il,
          n = ih;
        ...
        if (i !== ih) throw Error("invert: does not exist");
        return im(s, t);
      }
      let iE = [
        "create",
      ...
      function iI(e, t, r = !1, i = {}) {
        let s;
        if (e <= il) throw Error("invalid field: expected ORDER > 0, got " + e);
        let { nBitLength: n, nByteLength: o } = i_(e, t);
        if (o > 2048)
        ...
        let a = Object.freeze({
          ...
          pow: (e, t) =>
            (function (e, t, r) {
              ...
              if (r === il) return e.ONE;
              if (r === ih) return t;
              let i = e.ONE,
                s = t;
              for (; r > il; )
                r & ih && (i = e.mul(i, s)), (s = e.sqr(s)), (r >>= ih);
              return i;
            })(a, e, t),
          div: (t, r) => im(t * iv(r, e), e),
          sqrN: (e) => e * e,
          addN: (e, t) => e + t,
          subN: (e, t) => e - t,
          mulN: (e, t) => e * t,
              ...
              s ||
                (s = (function (e) {
                  ...
                  return (function (e) {
                    let t, r, i;
                    let s = (e - ih) / iu;
                    for (t = e - ih, r = 0; t % iu === il; t /= iu, r++);
                    for (i = iu; i < e && ib(i, s, e) !== e - ih; i++)
                      if (i > 1e3)
                        throw Error(
      ...
      function iC(e, t) {
        return (
          iA(e, t), { windows: Math.ceil(t / e) + 1, windowSize: 2 ** (e - 1) }
        );
      }
      let iT = new WeakMap(),
        iN = new WeakMap();
      ...
      function ij(e) {
        return (
          ...
          Object.freeze({ ...i_(e.n, e.nBitLength), ...e, p: e.Fp.ORDER })
        );
      }
      ...
      let iz = (function (e) {
        let t =
          ...
          c = t.powPminus2 || ((e) => ib(e, r - BigInt(2), r));
        function l(e, t, r) {
          let s = i(e * (t - r));
        ...
        function u(e, t) {
          let u = (function (e, t) {
            ...
            (function (e) {
              let t = r3("u coordinate", e, n);
              return 32 === o && (t[31] &= 127), r1(t);
            })(t),
            (function (e) {
              let t = r3("scalar", e),
                r = t.length;
          ...
          if (u === iL) throw Error("invalid private or public key received");
          return r8(i(u), n);
        }
        let d = r8(i(t.Gu), n);
        function p(e) {
        ...
        powPminus2: (e) => {
          let { pow_p_5_8: t, b2: r } = (function (e) {
            let t = BigInt(10),
              ...
              p = (iw(d, s, iU) * u) % iU,
              f = (iw(p, t, iU) * c) % iU;
            return { pow_p_5_8: (iw(f, iq, iU) * e) % iU, b2: n };
          })(e);
          return im(iw(t, i$, iU) * r, iU);
        },
      ...
      function iF(e) {
        void 0 !== e.lowS && rK("lowS", e.lowS),
          void 0 !== e.prehash && rK("prehash", e.prehash);
      }
      let { bytesToNumberBE: iH, hexToBytes: iV } = ic;
      ...
      let iG = {
          ...
          toSig(e) {
            let { Err: t, _int: r, _tlv: i } = iG,
              s = "string" == typeof e ? iV(e) : e;
            rV(s);
      ...
      let iJ = iI(
            ...
            (function (e) {
              ...
              let {
                  ...
                  function c(e) {
                    ...
                    try {
                      t =
                        "bigint" == typeof e ? e : r0(r3("private key", e, s));
                    } catch {
                      throw Error(
                    ...
                    return n && (t = im(t, o)), r9("private key", t, iY, o), t;
                  }
                  function l(e) {
                    if (!(e instanceof d))
                  ...
                  class d {
                    ...
                    static fromHex(e) {
                      let t = d.fromAffine(o(r3("pointHex", e)));
                    ...
                    toHex(e = !0) {
                      return rK("isCompressed", e), rW(this.toRawBytes(e));
                    }
                  }
                    ...
                    f =
                      ((t = r.endo ? Math.ceil(p / 2) : p),
                      {
                        ...
                        precomputeWindow(e, r) {
                          let { windows: i, windowSize: s } = iC(r, t),
                            n = [],
                            o = e,
                            a = o;
                          for (let e = 0; e < i; e++) {
                  ...
                  toBytes(e, t, i) {
                    ...
                    return (
                      rK("isCompressed", i),
                      i
                        ? r5(Uint8Array.from([t.hasEvenY() ? 2 : 3]), n)
                        : r5(Uint8Array.from([4]), n, r.toBytes(s.y))
                    );
                  },
                  fromBytes(e) {
                    let t = e.length,
                ...
                u = (e) => rW(r2(e, t.nByteLength)),
                d = (e, t, r) => r0(e.slice(t, r));
              class p {
                constructor(e, t, r) {
                  (this.r = e),
                    (this.s = t),
                ...
                static fromCompact(e) {
                  let r = t.nByteLength;
                  return new p(
                    d((e = r3("compactSignature", e, 2 * r)), 0, r),
                    d(e, r, 2 * r)
                  );
                }
                static fromDER(e) {
                  let { r: t, s: r } = iG.toSig(r3("DER", e));
                  return new p(t, r);
                }
                assertValidity() {
                  r9("r", this.r, iY, i), r9("s", this.s, iY, i);
                }
                addRecoveryBit(e) {
                ...
                toDERRawBytes() {
                  return rQ(this.toDERHex());
                }
                toDERHex() {
                  return iG.hexFromSig({ r: this.r, s: this.s });
                }
                toCompactRawBytes() {
              ...
              function b(e) {
                return (
                  r9("num < 2^" + t.nBitLength, e, iW, m), r2(e, t.nByteLength)
                );
              }
                  ...
                  sign: function (e, s, n = w) {
                    let { seed: l, k2sig: u } = (function (e, s, n = w) {
                      ...
                      null == d && (d = !0),
                        (e = r3("msgHash", e)),
                        iF(n),
                        f && (e = r3("prehashed msgHash", l(e)));
                      let v = y(e),
                        E = c(s),
                        _ = [b(E), b(v)];
                      if (null != m && !1 !== m) {
                        let e = !0 === m ? u(r.BYTES) : m;
                        _.push(r3("extraEntropy", e));
                      }
                      return {
                        seed: r5(..._),
                        k2sig: function (e) {
                          ...
                          let l = o(s * o(v + c * E));
                          if (l === iW) return;
                          let u = (2 * (n.x !== c)) | Number(n.y & iY),
                            f = l;
                          return (
                            d &&
                              l > i >> iY &&
                              ((f = (t = l) > i >> iY ? o(-t) : t), (u ^= 1)),
                            new p(c, f, u)
                          );
                        },
                      };
                    })(e, s, n);
                    return ii(t.hash.outputLen, t.nByteLength, t.hmac)(l, u);
                  },
                  verify: function (e, r, s, n = v) {
                    let c, l;
                    (r = r3("msgHash", r)), (s = r3("publicKey", s));
                    ...
                    try {
                      if ((g && (c = new p(e.r, e.s)), f)) {
                        try {
                          ...
                          if (!(e instanceof iG.Err)) throw e;
                        }
                    ...
                    let { r: m, s: b } = c,
                      ...
                      _ = o(w * E),
                      I = o(m * E),
                      x = a.BASE.multiplyAndAddUnsafe(l, _, I)?.toAffine();
                    return !!x && o(x.x) === m;
                  },
                  ProjectivePoint: a,
                  Signature: p,
                  utils: {
                    ...
                    randomPrivateKey: () => {
                      ...
                      return (function (e, t, r = !1) {
                        ...
                        let o = im(r ? r1(e) : r0(e), t - ih) + ih;
                        return r ? r8(o, s) : r2(o, s);
                      })(t.randomBytes(e), t.n);
                    },
        ...
        i5 = 2;
      function i6() {
        let e = iz.utils.randomPrivateKey(),
          t = iz.getPublicKey(e);
        return { privateKey: (0, ef.dI)(e, i0), publicKey: (0, ef.dI)(t, i0) };
      }
      function i4() {
        let e = tv(32);
        return (0, ef.dI)(e, i0);
      ...
      function i9(e, t) {
        let r = rj(
          r$,
          iz.getSharedSecret((0, ef.sH)(e, i0), (0, ef.sH)(t, i0)),
          void 0,
          void 0,
          32
        );
      ...
      function i7(e) {
        let t = r$((0, ef.sH)(e, i0));
        return (0, ef.dI)(t, i0);
      }
      function se(e) {
        let t = r$((0, ef.sH)(e, i8));
        return (0, ef.dI)(t, i0);
      }
      function st(e) {
        return (0, ef.sH)(`${e}`, iQ);
      ...
      function sn(e) {
        let t = st("u" > typeof e.type ? e.type : 0);
        if (sr(t) === i3 && typeof e.senderPublicKey > "u")
          throw Error("Missing sender public key for type 1 envelope");
        let r =
            "u" > typeof e.senderPublicKey
              ? (0, ef.sH)(e.senderPublicKey, i0)
              : void 0,
          i = "u" > typeof e.iv ? (0, ef.sH)(e.iv, i0) : tv(12),
          s = sl({
            type: t,
            sealed: rA((0, ef.sH)(e.symKey, i0), i).encrypt(
              (0, ef.sH)(e.message, i8)
            ),
            iv: i,
            senderPublicKey: r,
          });
        return e.encoding === i2 ? si(s) : s;
      }
      function so(e) {
        let t = (0, ef.sH)(e.symKey, i0),
          { sealed: r, iv: i } = sh({
            encoded: e.encoded,
            encoding: e.encoding,
          }),
      ...
      function sa(e, t) {
        let r = st(i5),
          i = tv(12),
          s = sl({ type: r, sealed: (0, ef.sH)(e, i8), iv: i });
        return t === i2 ? si(s) : s;
      }
      function sc(e, t) {
        let { sealed: r } = sh({ encoded: e, encoding: t });
        return (0, ef.dI)(r, i8);
      }
      function sl(e) {
        if (sr(e.type) === i5)
          return (0, ef.dI)((0, ef.xW)([e.type, e.sealed]), i1);
        if (sr(e.type) === i3) {
        ...
        return (0, ef.dI)((0, ef.xW)([e.type, e.iv, e.sealed]), i1);
      }
      function sh(e) {
        let t = (e.encoding || i1) === i2 ? ss(e.encoded) : e.encoded,
          r = (0, ef.sH)(t, i1),
          i = r.slice(0, 1);
        if (sr(i) === i3) {
          let e = r.slice(1, 33),
        ...
        if (sr(i) === i5) return { type: i, sealed: r.slice(1), iv: tv(12) };
        let s = r.slice(1, 13);
        return { type: i, sealed: r.slice(13), iv: s };
      }
      function su(e, t) {
        let r = sh({ encoded: e, encoding: t?.encoding });
        return sd({
          type: sr(r.type),
          senderPublicKey:
            "u" > typeof r.senderPublicKey
              ? (0, ef.dI)(r.senderPublicKey, i0)
              : void 0,
      ...
      function sg(e, t) {
        let [r, i, s] = e.split("."),
          n = ew.from(ss(s), "base64");
        if (64 !== n.length) throw Error("Invalid signature length");
        let o = n.slice(0, 32),
          a = n.slice(32, 64),
          c = r$(`${r}.${i}`),
          l = (function (e) {
            let t = ew.from(e.x, "base64"),
              r = ew.from(e.y, "base64");
            return (0, ef.xW)([new Uint8Array([4]), t, r]);
          })(t);
        if (!iX.verify((0, ef.xW)([o, a]), c, l))
      ...
      var sE = Object.defineProperty,
        ...
        sP = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        sO = (e, t) => {
          for (var r in t || (t = {})) sD.call(t, r) && sP(e, r, t[r]);
          if (sx) for (var r of sx(t)) sS.call(t, r) && sP(e, r, t[r]);
          return e;
        },
        sA = (e, t) => s_(e, sI(t));
      function sC(e) {
      ...
      function sR(e, t) {
        ...
        for (let [t, i] of Object.entries(r))
          i.methods ? (i.methods = e8(i.methods, e)) : (i.methods = e),
      ...
      function sk(e, t) {
        let { message: r, code: i } = sL[e];
        return { message: t ? `${r} ${t}` : r, code: i };
      }
      function sU(e, t) {
        let { message: r, code: i } = sj[e];
        return { message: t ? `${r} ${t}` : r, code: i };
      }
      function sB(e, t) {
        return (
      ...
      function sM(e, t) {
        return !!(t && s$(e)) || ("string" == typeof e && !!e.trim().length);
      }
      function sz(e, t) {
        return !!(t && s$(e)) || ("number" == typeof e && !isNaN(e));
      }
      function sF(e, t) {
        ...
        return (
          ...
          (i.forEach((t) => {
            let { accounts: i, methods: s, events: o } = e.namespaces[t],
              a = sC(i),
              c = r[t];
            (eV(eI(t, c), a) && eV(c.methods, s) && eV(c.events, o)) ||
              (n = !1);
          }),
          n)
        );
      ...
      function sH(e) {
        return !!(sM(e, !1) && e.includes(":")) && 2 === e.split(":").length;
      }
      function sV(e) {
        function t(e) {
          try {
      ...
      function sY(e) {
        let t = !0;
        return (
          sB(e) ? e.length && (t = e.every((e) => sM(e, !1))) : (t = !1), t
        );
      }
      function sZ(e, t) {
        let r = null;
      ...
      function s3(e) {
        return !(s$(e) || !sM(e.method, !1));
      }
      function s5(e) {
        return !(
          s$(e) ||
          (s$(e.result) && s$(e.error)) ||
          !sz(e.id, !1) ||
          !sM(e.jsonrpc, !1)
        );
      }
      function s6(e) {
        return !(s$(e) || !sM(e.name, !1));
      }
      function s4(e, t) {
        return !(
          !sH(t) ||
      ...
      Approved: ${a.toString()}`
        ...
        Approved: ${s.toString()}`
          ...
          o.forEach((e) => {
            i ||
              (eV(s[e].methods, n[e].methods)
                ? eV(s[e].events, n[e].events) ||
                  (i = sk(
                    "NON_CONFORMING_NAMESPACES",
      ...
      async function ns() {
        if (eL() && "u" > typeof r.g && null != r.g && r.g.NetInfo) {
    ...
    30565: (e, t, r) => {
        ...
        process(e, t) {
          ...
          for (let e = 0; e < 80; e++) {
            let t =
              ...
              x = (h & d) ^ (~h & f),
              D = (u & p) ^ (~u & v),
              S = g.add5L(_, I, D, m[e], w[e]),
              P = g.add5H(S, E, t, x, y[e], b[e]),
              O = 0 | S,
      ...
      function tx(e) {
        return (0, s.j)(t_(tI(e, eS), eP));
      }
      function tD(e) {
        return t_(tI((0, s.h)(e), eP), eS);
      }
      function tS(e) {
      ...
      async function tA(e, t, r, s, n = (0, i.fromMiliseconds)(Date.now())) {
        ...
        let c = { alg: "EdDSA", typ: "JWT" },
          ...
          h = tI(
            [tD((o = { header: c, payload: l }).header), tD(o.payload)].join(
              "."
            ),
            eO
          );
        return [
          tD(
            (a = {
              header: c,
              payload: l,
              signature: eD.sign(h, s.secretKey.slice(0, 32)),
            }).header
          ),
          tD(a.payload),
          t_(a.signature, eS),
    ...
    31507: (e, t, r) => {
      ...
      let ew = (e) => async (t) =>
        ...
        eA = "json",
        eC = 512,
        eT = (e) => eP.encode(JSON.stringify(e)),
        ...
        static create(e, t, r) {
          ...
          switch (e) {
            case 0:
              ...
              throw Error(
                `Version 0 CID must use dag-pb (code: ${eU}) block encoding`
              );
            case 1: {
