(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [7083],
  {
    ...
    27083: (e, t, n) => {
      "use strict";
      n.d(t, { createCoinbaseWalletSDK: () => ts });
      class r {
        constructor(e, t) {
      ...
      let d = {
        ...
        provider: {
          userRejectedRequest: (e) => f(i.provider.userRejectedRequest, e),
          unauthorized: (e) => f(i.provider.unauthorized, e),
          unsupportedMethod: (e) => f(i.provider.unsupportedMethod, e),
          disconnected: (e) => f(i.provider.disconnected, e),
          chainDisconnected: (e) => f(i.provider.chainDisconnected, e),
          unsupportedChain: (e) => f(i.provider.unsupportedChain, e),
          custom: (e) => {
            if (!e || "object" != typeof e || Array.isArray(e))
              throw Error(
      ...
      function P(e) {
        return m(`0x${BigInt(e).toString(16)}`);
      }
      function N(e) {
      ...
      function O(e, t = !1) {
        let n = (function (e, t = !1) {
          if ("string" == typeof e) {
            ...
            if (I.test(n)) return m(t ? `0x${n}` : n);
          }
          throw d.rpc.invalidParams(
            `"${String(e)}" is not a hexadecimal string`
          );
        })(e, !1);
        return n.length % 2 == 1 && (n = m(`0${n}`)), t ? m(`0x${n}`) : n;
      }
      function U(e) {
        if ("string" == typeof e) {
          let t = D(e).toLowerCase();
          if (T(t) && 40 === t.length) return _(R(t));
        }
      ...
      function W(e) {
        ...
        if ("string" == typeof e) {
          ...
          if (T(e)) return w(Number(BigInt(O(e, !0))));
        }
      ...
      let ev =
        ...
        ek = Array.from({ length: 256 }, (e, t) =>
          t.toString(16).padStart(2, "0")
        ),
        ex = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 };
      function eI(e) {
        return (
          "string" == typeof e &&
            (e = (function (e) {
      ...
      let eS = Uint32Array.from([
          0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f,
          0x9b05688c, 0x1f83d9ab, 0x5be0cd19,
        ]),
        eA = BigInt(0x100000000 - 1),
        eM = BigInt(32),
        eL = Uint32Array.from([
      ...
      class eN extends eC {
        ...
        process(e, t) {
          for (let n = 0; n < 16; n++, t += 4) eP[n] = e.getUint32(t, !1);
          for (let e = 16; e < 64; e++) {
            let t = eP[e - 15],
              n = eP[e - 2],
              r = ew(t, 7) ^ ew(t, 18) ^ (t >>> 3),
              i = ew(n, 17) ^ ew(n, 19) ^ (n >>> 10);
            eP[e] = (i + eP[e - 7] + r + eP[e - 16]) | 0;
          }
          ...
          for (let e = 0; e < 64; e++) {
            ...
            let t =
                (l +
                  (ew(a, 6) ^ ew(a, 11) ^ ew(a, 25)) +
                  (((u = a) & o) ^ (~u & c)) +
                  eL[e] +
                  eP[e]) |
                0,
              p =
                ((ew(n, 2) ^ ew(n, 13) ^ ew(n, 22)) +
                  (((d = n) & (h = r)) ^ (d & (f = i)) ^ (h & f))) |
                0;
            (l = c),
              (c = o),
        ...
        destroy() {
          this.set(0, 0, 0, 0, 0, 0, 0, 0), e_(this.buffer);
        }
      }
      !(function (e, t = !1) {
        let n = e.length,
        ...
        for (let s = 0; s < n; s++) {
          let { h: n, l: a } = (function (e, t = !1) {
            return t
              ? { h: Number(e & eA), l: Number((e >> eM) & eA) }
              : { h: 0 | Number((e >> eM) & eA), l: 0 | Number(e & eA) };
          })(e[s], t);
          [r[s], i[s]] = [n, a];
        }
      })(
      ...
      class eU {
        constructor(e, t, n, r = !1) {
          (this.storage = e),
            ...
            (this.secret = n),
            (this.key = (function (e) {
              if ((eb(e), ev)) return e.toHex();
              let t = "";
              for (let n = 0; n < e.length; n++) t += ek[e[n]];
              return t;
            })(eD(`${t}, ${n} WalletLink`))),
            (this._linked = !!r);
        }
        static create(e) {
          return new eU(e, E(16), E(32)).save();
        }
        static load(e) {
          let t = e.getItem(eR),
            n = e.getItem(eO),
            r = e.getItem(eT);
          return t && r ? new eU(e, t, r, "1" === n) : null;
        }
        get linked() {
          return this._linked;
        }
        ...
        save() {
          return (
            this.storage.setItem(eR, this.id),
            this.storage.setItem(eT, this.secret),
            this.persistLinked(),
            this
          );
        }
        persistLinked() {
          this.storage.setItem(eO, this._linked ? "1" : "0");
        }
      }
      function ej() {
        var e, t;
              ...
              (0, eq.h)(
                ...
                (0, eq.h)(
                  ...
                  Array.from(this.items.entries()).map(([e, t]) =>
                    (0, eq.h)(eK, Object.assign({}, t, { key: e }))
                  )
                )
              ),
              this.root
      ...
      let eF = (e) =>
          (0, eq.h)(
            "div",
            { class: eB("-cbwsdk-snackbar-container") },
            (0, eq.h)(
              "style",
              null,
            ...
            (0, eq.h)("div", { class: "-cbwsdk-snackbar" }, e.children)
          ),
        eK = ({ autoExpand: e, message: t, menuItems: n }) => {
          let [r, i] = (0, eH.useState)(!0),
            [s, a] = (0, eH.useState)(null != e && e);
          return (
            (0, eH.useEffect)(() => {
              let e = [
                window.setTimeout(() => {
      ...
      class e$ {
        constructor() {
          (this.root = null), (this.darkMode = ej());
        }
        attach() {
          let e = document.documentElement;
          (this.root = document.createElement("div")),
          ...
          (0, eq.h)(
            ...
            (0, eq.h)(
              ...
              (0, eq.h)(
                ...
                (0, eq.h)("p", null, e),
                (0, eq.h)("button", { onClick: r }, t)
              )
            )
          ),
        eJ = "https://www.walletlink.org";
      class eY {
        constructor() {
          (this.attached = !1), (this.redirectDialog = new e$());
        }
        attach() {
          if (this.attached)
            throw Error("Coinbase Wallet SDK UI is already attached");
      ...
      class eQ {
          ...
          (this.chainCallbackParams = { chainId: "", jsonRpcUrl: "" }),
            ...
            (this.accountUpdated = (e) => {
              this.accountsCallback && this.accountsCallback([e]),
                eQ.accountRequestCallbackIds.size > 0 &&
                  (Array.from(eQ.accountRequestCallbackIds.values()).forEach(
                    (t) => {
                  ...
                  eQ.accountRequestCallbackIds.clear());
            }),
        ...
        subscribe() {
          let e = eU.load(this.storage) || eU.create(this.storage),
            { linkAPIUrl: t } = this,
            n = new ep({ session: e, linkAPIUrl: t, listener: this }),
            r = this.isMobileWeb ? new eY() : new eG();
        ...
        submitEthereumTransaction(e, t) {
          return this.sendRequest({
            ...
            params: { signedTransaction: A(e, !0), chainId: t },
          });
        }
        ...
        handleWeb3ResponseMessage(e, t) {
          if ("requestEthereumAccounts" === t.method) {
            eQ.accountRequestCallbackIds.forEach((e) =>
        ...
        requestEthereumAccounts() {
          ...
          return new Promise((e, t) => {
            this.relayEventManager.callbacks.set(r, (n) => {
              ...
              eQ.accountRequestCallbackIds.add(r),
      ...
      eQ.accountRequestCallbackIds = new Set();
      var eZ = n(44134).Buffer;
      let eX = "DefaultChainId",
        e0 = "DefaultJsonRpcUrl";
      class e1 {
        constructor(e) {
          (this._relay = null),
            (this._addresses = []),
            (this.metadata = e.metadata),
            (this._storage = new r("walletlink", eJ)),
        ...
        get jsonRpcUrl() {
          var e;
          return null !== (e = this._storage.getItem(e0)) && void 0 !== e
            ? e
            : void 0;
        }
        set jsonRpcUrl(e) {
          this._storage.setItem(e0, e);
        }
        updateProviderInfo(e, t) {
          var n;
          this.jsonRpcUrl = e;
          let r = this.getChainId();
          this._storage.setItem(eX, t.toString(10)),
            W(t) !== r &&
              (null === (n = this.callback) ||
                void 0 === n ||
        ...
        _prepareTransactionParams(e) {
          ...
          let n = e.to ? U(e.to) : null,
            r = null != e.value ? B(e.value) : BigInt(0),
            i = e.data ? j(e.data) : eZ.alloc(0),
            s = null != e.nonce ? W(e.nonce) : null,
            a = null != e.gasPrice ? B(e.gasPrice) : null,
            o = null != e.maxFeePerGas ? B(e.maxFeePerGas) : null,
            c =
              null != e.maxPriorityFeePerGas ? B(e.maxPriorityFeePerGas) : null;
          return {
            fromAddress: t,
            toAddress: n,
            weiValue: r,
        ...
        getChainId() {
          ...
          return Number.parseInt(
            null !== (e = this._storage.getItem(eX)) && void 0 !== e ? e : "1",
            10
          );
        }
      ...
      let e2 = "SignerType",
        e3 = new r("CBWSDK", "SignerConfigurator");
      async function e5(e) {
        let {
          communicator: t,
          metadata: n,
      ...
      async function e4(e, t, n) {
        await e.onMessage(({ event: e }) => "WalletLinkSessionRequest" === e);
        let r = new e1({ metadata: t, callback: n });
        e.postMessage({
      ...
      let e8 = `Coinbase Wallet SDK requires the Cross-Origin-Opener-Policy header to not be set to 'same-origin'. This is to ensure that the SDK can communicate with the Coinbase Smart Wallet app.

Please see https://www.smartwallet.dev/guides/tips/popup-tips#cross-origin-opener-policy for more information.`,
        { checkCrossOriginOpenerPolicy: e6, getCrossOriginOpenerPolicy: e7 } =
          (() => {
            let e;
            return {
              ...
              checkCrossOriginOpenerPolicy: async () => {
                ...
                try {
                  ...
                  (e = null != r ? r : "null"),
                    "same-origin" === e && console.error(e8);
                } catch (t) {
                  console.error(
              ...
              switch (e.method) {
                case "eth_requestAccounts": {
                  let t = await this.requestSignerSelection(e),
                    n = this.initSigner(t);
                  await n.handshake(e), (this.signer = n), e3.setItem(e2, t);
                  break;
                }
                case "wallet_sendCalls": {
        ...
        initSigner(e) {
          return (function (e) {
            ...
            switch (t) {
              ...
              case "walletlink":
                return new e1({ metadata: n, callback: i });
            }
          })({
            signerType: e,
            metadata: this.metadata,
      ...
      function ts(e) {
        var t;
        new r("CBWSDK").setItem("VERSION", ee), e6();
        let n = {
          metadata: {
    ...
    34675: (e, t, n) => {
      ...
      t.Keccak = w;
      let v = (e, t, n) => (0, i.createHasher)(() => new w(t, e, n));
    ...
    66117: (e, t, n) => {
      ...
      function A(e) {
        ((!e.__d && (e.__d = !0) && o.push(e) && !M.__r++) ||
          c != i.debounceRendering) &&
          ((c = i.debounceRendering) || l)(M);
      }
      function M() {
      ...
      function L(e, t, n, r, s, a, o, c, l, u, d) {
        ...
        for (
          ...
          null != (p = n.__k[h]) &&
            ((f = -1 == p.__i ? b : k[p.__i] || b),
            (p.__i = h),
            (w = R(e, p, f, s, a, o, c, l, u, d)),
            (g = p.__e),
            p.ref &&
              f.ref != p.ref &&
              (f.ref && O(f.ref, null, p), d.push(p.ref, p.__c || g, p)),
            null == _ && null != g && (_ = g),
            4 & p.__u || f.__k === p.__k
              ? (l = (function e(t, n, r) {
                  var i, s;
        ...
        e: if ("style" == t) {
          ...
          (s = t != (t = t.replace(d, "$1"))),
            ...
            n
              ? r
                ? (n.u = r.u)
                : ((n.u = h), e.addEventListener(t, s ? p : f, s))
              : e.removeEventListener(t, s ? p : f, s);
        else {
        ...
        e: if ("function" == typeof W)
          try {
            if (
              ...
              (A = (h = W.contextType) && s[h.__c]),
              (M = h ? (A ? A.props.value : h.__) : s),
              n.__c
                ? (k = (f = t.__c = n.__c).__ = f.__E)
                : (I
                    ? (t.__c = f = new W(x, M))
                    : ((t.__c = f = new C(x, M)),
                      (f.constructor = W),
                  ...
                  (f.__h = []),
                  (f._sb = [])),
              I && null == f.__s && (f.__s = f.state),
              I &&
                null != W.getDerivedStateFromProps &&
                (f.__s == f.state && (f.__s = w({}, f.__s)),
                w(f.__s, W.getDerivedStateFromProps(x, f.__s))),
              (g = f.props),
              (m = f.state),
              (f.__v = t),
              p)
              ...
              if (
                (I &&
                  ...
                  f.componentWillReceiveProps(x, M),
                (!f.__e &&
                  null != f.shouldComponentUpdate &&
                  !1 === f.shouldComponentUpdate(x, f.__s, M)) ||
                  t.__v == n.__v)
              ) {
                for (
                  t.__v != n.__v &&
              ...
              null != f.componentWillUpdate &&
                f.componentWillUpdate(x, f.__s, M),
                I &&
                  null != f.componentDidUpdate &&
                  f.__h.push(function () {
                    f.componentDidUpdate(g, m, _);
                  });
            }
            if (
              ((f.context = M),
            ...
            (f.state = f.__s),
              null != f.getChildContext &&
                (s = w(w({}, s), f.getChildContext())),
              I &&
                !p &&
                null != f.getSnapshotBeforeUpdate &&
                (_ = f.getSnapshotBeforeUpdate(g, m)),
              (O = h),
              null != h &&
                h.type === E &&
                null == h.key &&
              ...
              (l = L(e, y(O) ? O : [O], t, n, s, a, o, c, l, u, d)),
              (f.base = t.__e),
              (t.__u &= -161),
    ...
    67885: (e, t, n) => {
      ...
      function _(e) {
        let t = (t, n) => e(n).update(g(t)).digest(),
          n = e({});
        return (
          (t.outputLen = n.outputLen),
          (t.blockLen = n.blockLen),
